export const ProductPriceRules = [
  {
    ...
    },
    {
        ...
        errorString: "`qty_1_max` should be greater than `qty_1_min`, please provide valid data at row number",
    ...
    },
    {
        ...
        errorString: "`qty_2_min` should be greater than `qty_1_max`, please provide valid data at row number",
